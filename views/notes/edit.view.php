        ...
        <form method="POST" action="/note">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea
                                    ...
                                    placeholder="Here's new idea"><?= $note['body'] ?? '' ?></textarea>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <a
                    href="/notes"
                    type="button"
                    class="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-red-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 dark:bg-red-500 dark:shadow-none dark:focus-visible:outline-red-500">
                    Cancel
                </a>
                <button
                    type="submit"
